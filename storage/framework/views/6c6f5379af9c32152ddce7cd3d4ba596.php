...
<section class="bg-white dark:bg-gray-900">
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 grid grid-cols-1 lg:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <img class="w-[57rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 md:w-[74rem] lg:w-[67rem]" src="<?php echo e(asset('/imgs/dog_owners.jpg')); ?>" alt="">
    </div>
</section>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('animal.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\animalTalent\resources\views/animal/aboutUs.blade.php ENDPATH**/ ?>