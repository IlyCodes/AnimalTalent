...
<div class="bg-white">
  ...
  <div class="relative isolate px-6 pt-10 lg:px-8">
    <div class="mx-auto max-w-2xl">
      <img src="<?php echo e(asset('/banner/animalBanner.png')); ?>" alt="bn">
  ...
  <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
    <div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
      ...
      <div class="relative mt-16 h-80 lg:mt-8">
        <img class="absolute left-0 top-0 w-[52rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10" src="<?php echo e(asset('/imgs/animals.png')); ?>" alt="App screenshot" width="1824" height="1080">
      </div>
    </div>
  </div>
</div>
...
<div class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
  ...
  <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
    ...
    <div class="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
      <img class="w-[48rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]" src="<?php echo e(asset('/imgs/dog_owners.jpg')); ?>" alt="">
    </div>
    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
      ...
      <div class="grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:pt-2">
        ...
        <div class="flex flex-col items-start">
          <a href="<?php echo e(route('animals.index')); ?>" class="text-m font-semibold leading-6 text-white hover:underline">Animals</a><br>
          <a href="<?php echo e(route('owners')); ?>" class="text-m font-semibold leading-6 text-white hover:underline">Owners</a><br>
          <a href="<?php echo e(route('competitions')); ?>" class="text-m font-semibold leading-6 text-white hover:underline">Competitions</a><br>
          <a href="<?php echo e(route('about_us')); ?>" class="text-m font-semibold leading-6 text-white hover:underline">About Us</a>
        </div>

        <div class="flex flex-col items-start">
          <a href="<?php echo e(route('create_judge')); ?>" class="text-m font-semibold leading-6 text-white hover:underline">Apply as a new judge<span aria-hidden="true">&rarr;</span></a><br>
          <a href="<?php echo e(route('animals.create')); ?>" class="text-m font-semibold leading-6 text-white hover:underline">Apply as a new owner<span aria-hidden="true">&rarr;</span></a><br>
          <a href="<?php echo e(route('add_new_animal')); ?>" class="text-m font-semibold leading-6 text-white hover:underline">Add your new Animal<span aria-hidden="true">&rarr;</span></a><br>
          <a href="<?php echo e(route('dashboard')); ?>" class="text-m font-semibold leading-6 text-white hover:underline">Admin Dashboard<span aria-hidden="true">&rarr;</span></a>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('animal.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\animalTalent\resources\views/welcome.blade.php ENDPATH**/ ?>