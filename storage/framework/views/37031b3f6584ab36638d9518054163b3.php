...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('store_competition')); ?>" method="post">
        ...
        <div class="lg:ml-48 lg:mr-48 ml-4 mr-4">
            ...
            <div class="mt-10 grid grid-cols-2 gap-x-6 gap-y-8">
                ...
                <div class="mt-2">
                    <input type="date" name="date" id="date" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                </div>
                ...
                <div class="sm:col-span-1">
                    ...
                    <div class="mt-2">
                        <input type="text" name="winner" id="winner" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                <!-- <div class="mt-2">
                ...
                <div class="mt-2">
                    <input type="number" name="finished" id="finished" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                </div>
                ...
                <div class="mt-2">
                    <select class="rounded-lg" name="judge_id" id="judge">
                        <option class="hidden">Choose Judge</option>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\animalTalent\resources\views/admin/createCompetition.blade.php ENDPATH**/ ?>